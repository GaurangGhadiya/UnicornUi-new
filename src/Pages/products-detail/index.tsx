  ...
  return (
    <>
      <div className="primary-content-area container content-padding product-page-ds">
        <div
          className="main-content-area product-ds w-100"
          style={{ width: '68vw' }}
        >
            ...
            {/* <div className="product-details">
              ...
              <div className="product-details-wrapper">
                ...
                <ul className="details-value">
                  ...
                  <li>
                    {moment(productdata[0]?.updatedAt).format('MMM DD,YYYY')}
                  </li>
                  <li>
              ...
              <div className="seller-box">
                <div className="avatar box-64">
                  ...
                  >
                    <img
                      src={
                        Bucket + productdata[0]?.createdBy[0]?.image !== null
                          ? '/Image/avatar.png'
                          : Bucket + productdata[0]?.createdBy[0]?.image
                      }
                      alt="avatar"
      ...
      <div className="container">
        <div className="row product-additional-info2 detail-margin">
      ...
      <Dialog
        ...
        maxWidth="xl"
      >
        <DialogContent className="px-5 pt-2 pb-5">
