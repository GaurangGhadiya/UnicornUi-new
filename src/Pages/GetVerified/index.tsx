        ...
        {!Loding ? (
          <div className="user-db-content-area">
            <div className="upload-photo-box">
              <div className="user-db-title">Submit Verification Request</div>
            ...
            >
              ...
              <div className="form-group row">
                <div className="form-field col-md-6">
                  ...
                  <div className="row URl">
                    <FaBehance className="col-1 ms-md-2" />
                    <input
                      type="text"
                      id="Behance"
                      className="col-10 ms-1"
                ...
                <div className="form-field col-md-6">
                  ...
                  <div className="row URl">
                    <FiGithub className="col-1 ms-md-2" />
                    <input
                      type="text"
                      id="Github"
                      className="col-10 ms-1"
              ...
              >
                {isLoding ? 'Loading...' : 'Submit Request & Save Changes'}
              </button>
            </form>
          </div>
        ) : (
